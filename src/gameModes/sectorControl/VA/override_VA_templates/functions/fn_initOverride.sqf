...
if ( hasInterface ) then {
    
    {
        ...
        "VA_fnc_overrideVAButtonDown", 
        "VA_fnc_overrideVATemplateOK",
        "VA_fnc_loadInventory_whiteList",
        "VA_fnc_applyLBColors",
        "VA_fnc_showRestrictedItems",
        "VA_fnc_addVAKeyEvents"
    ];
    ...
    [ missionNamespace, "arsenalOpened", {
        ...
        uiNamespace setVariable [ "VA_override_virtualCargo", _virtualCargo ];
