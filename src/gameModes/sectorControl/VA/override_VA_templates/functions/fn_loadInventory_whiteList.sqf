...
scopeName "VA_fnc_loadInventory_whiteList";
...
if (_nameID >= 0) then {
    ...
    ["Inventory '%1' not found",_name] call BIS_fnc_error; breakOut "VA_fnc_loadInventory_whiteList";
};
...
if !(local _object) exitWith {[[_object,_cfg,_whiteList],"VA_fnc_loadInventory_whiteList",_object] call BIS_fnc_MP; false};
...
//_showNotification = getMissionConfigValue[ "VA_overrideVA_showMsg", 0 ];
//if !( isNil { missionNamespace getVariable "VA_overrideVA_msgThread" } ) then {
//    disableSerialization;
//    _display = uiNamespace getVariable "RscDisplayArsenal";
//    _ctrlGrp = ( missionNamespace getVariable "VA_overrideVA_msgCtrls" ) deleteAt 0;
//    {
//        _ctrl = _display displayCtrl _ctrlGrp controlsGroupCtrl _x;
//        ctrlDelete _ctrl;
//    }forEach ( missionNamespace getVariable "VA_overrideVA_msgCtrls" );
//    ctrlDelete ( _display displayCtrl _ctrlGrp );
//
//    terminate ( missionNamespace getVariable "VA_overrideVA_msgThread" );
//};
//if ( _showNotification > 0 && { _notAllowed isEqualTo true } ) then {
//    missionNamespace setVariable [ "VA_overrideVA_msgThread", [ _notification, _showNotification ] spawn {
//        disableSerialization;
...
//        missionNamespace setVariable [ "VA_overrideVA_msgCtrls", [ ctrlIDC _ctrlGrp, ctrlIDC _pic, ctrlIDC _ctrl ] ];
