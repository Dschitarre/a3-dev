...
if ((_unit getVariable ["callHelpDelay", 0]) > diag_tickTime) exitWith { false}; // ["You already have called for help!"] call AIS_Core_fnc_dynamicText;
_unit setVariable ["callHelpDelay", diag_tickTime + 3];
