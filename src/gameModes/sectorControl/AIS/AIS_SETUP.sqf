...
AIS_UNCONSCIOUS_DAMAGE_TOLLERANCE_FACTOR =     0.12;
AIS_BLEEDOUT_TIME             =     120;             // Basic life time in seconds until the unit bleed out and die.. The real life time depends on the real damage of the unit. (can be less or more time from the basic value)
